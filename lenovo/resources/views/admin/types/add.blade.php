		...
		<div class="panel-body">
			<form action="/admin/types" method="post">
				<div class="form-group">
					...
					<input type="hidden" name="pid" value="{{isset($_GET['pid'])?$_GET['pid']:0}}">
					<input type="hidden" name="path" value="{{isset($_GET['pid'])?$_GET['path']:"0,"}}">
				</div>

				<div class="form-group">
					<label for="">SORT</label>
					<input type="text" name="sort" class="form-control" placeholder="请输入sort">
				</div>
				...
				<div class="form-group">
					...
					<input type="text" name="keywords" class="form-control" placeholder="请输入keywords">
				</div>

				<div class="form-group">
					<label for="">DESCRIPTION</label>
					<input type="text" name="description" class="form-control" placeholder="请输入description">
				</div>
