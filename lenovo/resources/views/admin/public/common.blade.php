...
<head>
    ...
    <link rel="shortcut icon" href="/style/admin/public/img/1.png">
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin"><img style="display:inline" width="30px" src="/style/admin/public/img/1.png" alt="">   联想后台管理系统</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="http://www.lianxiang.com">前台首页</a></li>
